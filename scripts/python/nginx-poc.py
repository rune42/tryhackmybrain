#!/usr/bin/env python3
## ----------------------------------------------------------------------------------------
# This script was obtained from the TryHackMe room covering the CVE-2026–42945 vulnerability
# popularly known as Nginx Rift. It is a proof of concept that pipes in a heap buffer overflow
# onto a vulnerable Nginx server that causes it to become vulnerable to Remote Code Execution.
## ----------------------------------------------------------------------------------------
import argparse
import socket
import struct
